...
class TestGameSessionDAO:
    ...
    #     async def test_get_game_session_by_id_not_found(self, dao):
    #         """Тест получения несуществующей игровой сессии."""
    #         result = await dao.get_one_or_none(id=99999)
    ...
    #         assert all(isinstance(session, GameSession) for session in result)
