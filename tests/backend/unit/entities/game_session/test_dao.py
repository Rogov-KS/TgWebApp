...
class TestGameSessionDAO:
    ...
    class TestCreate:
        ...
        async def test_create_game_session_success(self, dao, insert_test_user: UserDB, get_game_session_data: dict):
            ...
            assert game_session.is_completed == game_session_data["is_completed"]
            assert game_session.game_data == game_session_data["game_data"]
            assert game_session.id is not None

        async def test_create_game_session_minimal_data(self, dao, insert_test_user: UserDB):
        ...
        async def test_create_game_session_with_invalid_user_id(self, dao, insert_test_user: UserDB):
            """Тест создания игровой сессии с минимальными данными."""
    ...
    class TestGetOneOrNone:
        ...
        async def test_get_game_session_by_id_success(
            self, dao: GameSessionDAO, insert_test_game_session: GameSessionDB
        ):
        ...
        async def test_get_game_session_by_user_id(
            self, dao: GameSessionDAO, insert_test_game_sessions: list[GameSessionDB]
        ):
    ...
    class TestGetAll:
        ...
        async def test_get_all_game_sessions(self, dao, insert_test_game_sessions: list[GameSessionDB]):
        ...
        async def test_get_game_sessions_by_user_id(self, dao, insert_test_game_sessions: list[GameSessionDB]):
        ...
        async def test_get_completed_game_sessions(self, dao, insert_test_game_sessions: list[GameSessionDB]):
    ...
    class TestUpdate:
        ...
        async def test_update_game_session_success(self, dao, insert_test_game_session: GameSessionDB):
            ...
            result = await dao.update(filters={"id": insert_test_game_session.id}, update_data=update_data)
        ...
        async def test_update_game_session_not_found(self, dao, insert_test_game_session: GameSessionDB):
            ...
            result = await dao.update(filters={"id": insert_test_game_session.id + 1}, update_data=update_data)
        ...
        async def test_update_game_session_empty_data(self, dao, insert_test_game_session: GameSessionDB):
            ...
            with pytest.raises(ValueError, match="Filters and update data cannot be empty"):
                await dao.update(filters={"id": insert_test_game_session.id}, update_data={})

    class TestDelete:
        """Тесты для метода delete."""

        async def test_delete_game_session_success(self, dao, insert_test_game_session: GameSessionDB):
    ...
    class TestGetMaxScore:
        ...
        async def test_get_user_max_score_user_with_no_sessions(
        ...
        async def test_get_user_max_score_invalid_user_id_zero(
            self, dao, insert_test_game_sessions: list[GameSessionDB]
        ):
        ...
        async def test_get_user_max_score_invalid_user_id_negative(
            self, dao, insert_test_game_sessions: list[GameSessionDB]
        ):
        ...
        async def test_get_user_max_score_invalid_user_id_type(
            self, dao, insert_test_game_sessions: list[GameSessionDB]
        ):
