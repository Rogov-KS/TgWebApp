    ...
    <div className="gradient-primary border-b border-slate-300 dark:border-white/20 relative z-20">
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          {/* Logo */}
          <div>
            <h1 className="text-slate-800 dark:text-white text-xl font-bold">
              Snake Game
            </h1>
            <p className="text-slate-600 dark:text-gray-300 text-xs">
              Telegram Web App
            </p>
          </div>
          ...
          <div className="flex justify-between items-center mb-5">
            <h2 className="text-slate-800 dark:text-white m-0">Snake Game</h2>
